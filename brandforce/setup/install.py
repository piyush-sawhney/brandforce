...
def update_app_name():
	frappe.db.set_value("System Settings", None, "default_app", "brandforce")
	frappe.db.set_value("Website Settings", None, "app_name", "Brandforce360")
	frappe.db.set_value("Website Settings", None, "title_prefix", "Brandforce360")
